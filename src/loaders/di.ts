...
import {
  ...
  RentalPricingRepository,
} from '@/modules/booking/application/repository/booking.repository';
...
export const initializeDI = (dataSource: DataSource) => {
  ...
  Container.set(CarsRepositoryToken, CarRepositoryFacrory.create(dataSource));
  ...
  Container.set(HttpService, new HttpService());
  ...
  Container.set(SerializerService, new SerializerService());
